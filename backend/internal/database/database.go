...
func Open(cfg config.Config) (*gorm.DB, error) {
	...
	if err := db.AutoMigrate(&model.User{}, &model.TrustAnchor{}, &model.CertificateChain{}, &model.DependentService{}, &model.RolloverScenario{}, &model.RolloverSignoff{}, &model.AuditLog{}); err != nil {
